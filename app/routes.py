...
def index():
    ...
    return render_template('index.html', title='Home Page', posts=posts.items, form=form, prev_url=prev_url, next_url=next_url)
...
def reset_password_request():
    ...
    if form.validate_on_submit():
        ...
        flash("Check your registered email for the instructions to reset your password")
        return redirect(url_for('login'))
